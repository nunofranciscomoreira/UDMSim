...
public:
	...
	/**
	 * Nuno Francisco Moreira @inesctec
	 * Clear any existing waypoints and set the current waypoint
	 * time to Simulator::Now(). Calling this is only a way of clear waypoints on callback functions of packet sinks
	 */
	void ClearMobility(void);
